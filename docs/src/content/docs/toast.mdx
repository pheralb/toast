---
title: 'Toast'
description: 'Use toast to create a toast from anywhere in your React application. Make sure you add the <Toaster /> provider to your app first.'
category: 'API'
---
